...
//connect
//click on connect on top first after creating instance
//click on link created instance server
//ec2 instance page 
// down click on connect


//commends of aws after connecting
-----------
staep1:sudo su

step(its not youtube link paste as its it commend) 1:   curl --silent --location https://rpm.nodesource.com/setup_4.x | bash -



step2:  yum -y install nodejs   /or/sudo yum install -y node.js

step3:yum install git  //sudo yum install git -y
sudo -v---it should be-v14
y
step4:git clone (code:https://github.com/kirankiranbang/expensetrackers.git)
ls
enter
again ls

cd https://github.com/kirankiranbang/expensetrackers.git
ls
...
npm i
----------
if err came while installing (npm i)
mkdir newwork
rm -rf newwork           (rm-remove ,rf-remove forceablly)
or sudo npm i
npm start

---------------------------------------------------------------
//not working or any error in aws any u try this code
//this for clearing and again running on aws
----------------------------------------------
sudo npm install
rm -rf /home/ec2-user/expensetracker-main/node_modules/node-addon-api/build
npm install
---------------------------------------------------------
npm cache clean --force
rm -rf node_modules
